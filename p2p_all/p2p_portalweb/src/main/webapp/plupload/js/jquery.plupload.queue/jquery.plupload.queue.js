(function(c) {
	...
	function b(f, e) {
		...
		var hr = '<div class="plupload_wrapper plupload_scroll"><div id="'
			+ f
			...
			+ a("Size")
			+ '</div><div class="plupload_clearer">&nbsp;</div></div>';
		if($('#'+f+'_filelist').children().length > 0){
			hr = hr + '<ul id="'
				+ f
				+ '_filelist" class="plupload_filelist">'+$('#'+f+'_filelist').html()+'</ul>' ;
		}else{
			hr = hr + '<ul id="'
				+ f
				+ '_filelist" class="plupload_filelist"></ul>';
		}
		hr = hr + '<div class="plupload_filelist_footer"><div class="plupload_file_name"><div class="plupload_buttons"><a href="#" class="plupload_button plupload_add">'
		+ a("Add files")
		...
		if (e) {
			this
					.each(function() {
						...
						function g() {
							var m = c("ul.plupload_filelist", i).html(or), n = 0, l;
							c
									.each(
											j.files,
											function(p, o) {
