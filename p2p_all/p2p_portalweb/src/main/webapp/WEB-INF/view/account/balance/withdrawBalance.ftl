 <form action="" name="" id="withdrawBalanceForm" method="post">
...
$("#password_submit").on("click",function(){
	if($("#withdrawBalanceForm").valid()){
		$.ajax({
	        type: "POST",
	        url: "withdrawBalance.htm",
	        async:false,
	        data: $("#withdrawBalanceForm").serialize(),
