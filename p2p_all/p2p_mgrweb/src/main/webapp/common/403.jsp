...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="page-error">
			<div class="page-img img403"></div>
			<div class="page-solve">
				<span class="p-s-t403">糟糕!业务异常，服务器未找到请求的网页</span>
				<span >试试 以下的几种方法吧：</span>
				<span >1.检查网址是否正确。</span>
				<span >2.<a href = "${ctx}/j_admin_logout?j_appname=${sessionScope.j_appname}" >重新登录。</a></span>
			</div>
			<div class="clear"></div>
		</div>
	</body>
