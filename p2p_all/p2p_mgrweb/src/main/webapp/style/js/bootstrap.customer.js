...
/* ===========================================================
 * bootstrap-select.js j2
 * http://jasny.github.com/bootstrap/javascript.html#select
 * ===========================================================
...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function (e) {
            this.$element.css({"position":"absolute","display":"inline-block","z-index":"-9999"});
        ...
        getTemplate: function() {
            var template =
                "<div class='btn-group bootstrap-select'>" +
                    "<span class='btn dropdown-toggle clearfix' data-toggle='dropdown'>" +
        ...
        clickListener: function() {
            ...
            $(this.$newElement).on('click', 'li a', function(e){
                ...
                if ($select.prev('select').not(':disabled')){
					...
					// 2015 Trigger select 'blur'
					$select.prev('select').trigger('blur');
                }
...
!function ($) {
  ...
  * ================================= */
  ...
  var Fileupload = function (element, options) {
    ...
    // 20150519 shiyuanfu 清除文件时name属性需提交后台暂用 清除时name已被清掉 无法提交 所以换成data-name 替换成name
    this.name = this.$input.data('name') || options.name
  ...
  Fileupload.prototype = {
    ...
    change: function(e, invoked) {
      ...
      this.$hidden.val('')
      // 20150519 shiyuanfu 清除文件时name属性需提交后台暂用 清除时name已被清掉 无法提交 所以换成data-name 替换成name
      this.$hidden.data('name', '')
      this.$input.data('name', this.name)
      ...
      this.$input.parent().siblings(".popoverbox").children(".popover-validate").show();
    },

    clear: function(e) {
      this.$hidden.val('')
      // 20150519 shiyuanfu 清除文件时name属性需提交后台暂用 清除时name已被清掉 无法提交 所以换成data-name 替换成name
      this.$hidden.data('name', this.name)
      ...
      this.$element.parent().siblings("input:hidden").val('');
      if (e) {
