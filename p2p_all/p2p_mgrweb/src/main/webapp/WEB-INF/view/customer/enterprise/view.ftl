...
<div class="col_main">
    <div class="main_hd">
        <div class="clearfix">
            <h2><@ctl.linkButton class="btn btn_primary" href="${taglibs.allctx}/customer/enterprise/index.htm" title="return" text="return"/>
                view</h2>
        </div>
    </div>
    <div class="main_bd">
        <div class="tab">
                        ...
                        <tr>
                            <td class="table_right_border size1of2">
                                ...
                                <div class="frm_controls">
                                    <span class="frm_val">${(customerDto.enterpriseDto.customerName)!}</span>
                                </div>
                            </td>
                            <td class=" size1of2">
                                <label class="frm_label">Business license:</label>
                                <div class="frm_controls">
                                    <span class="frm_val">${(customerDto.enterpriseDto.licenseNumbers)!}</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_right_border size1of2">
                                ...
                                <div class="frm_controls">
                                    <span class="frm_val">${(customerDto.enterpriseDto.contactName)!}</span>
                                </div>
                            </td>
                            <td class=" size1of2">
                                <label class="frm_label">Contact phone:</label>
                                <div class="frm_controls">
                                    <span class="frm_val">${(customerDto.enterpriseDto.cellphone)!}</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_right_border size1of2">
                                ...
                                <div class="frm_controls">
                                    <span class="frm_val">${(customerDto.enterpriseDto.email)!}</span>
                                </div>
                            </td>
                            <td class="size1of2">
            ...
            <#--融资概况-->
                <div class="form_wrp tab-bd-con hide">
                    <p class="mtb-10 tr"><a href="javascript:;" onclick=otherView("${(customerDto.enterpriseDto.customerName)!}") title="">more</a></p>
                    <div class="item">
