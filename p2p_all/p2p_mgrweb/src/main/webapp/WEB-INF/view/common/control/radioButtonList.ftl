...
<#macro radiobuttonlist 
	id="" name="" groupCode="" value="" dataType="" data="" class="frm_radio radio" labelClass="frm_radio_label" spanClass="frm_radio_box uniformjs supplement_info_radio" listData={}
	>
