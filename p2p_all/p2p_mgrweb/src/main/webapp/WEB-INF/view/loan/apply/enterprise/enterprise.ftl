            ...
            <div class="main_bd" >
                <div class="highlight_box ">
                	...
                	<form id="loanfrm" method="POST">
                        <div class="fl" >
                            <span>Please fill in Enterprise name: </span>
                            <span class="frm_input_box search with_del append ">
                                ...
                                <input id="keyInput" type="text" placeholder="Enterprise name"  name="customer.customerName" class="frm_input" />
                                <input  type="hidden"  name="customer.type" value="2"/>
                            </span>
                        </div>
                        </form>
