			...
			<div class="col_main">
                    ...
                    <div class="main_bd">
                    	<div class="tab" id="originalTab">
                            ...
                            <div class="tab-bd">
                     			<form id="loanFrm" action="${taglibs.ctx}/loan/apply/enterpriseApply.htm" method="post" enctype="multipart/form-data">
                     				<@ctl.token /> 
	                            	<#include "${taglibs.ftlctx}/loan/apply/enterprise/basic.ftl" />
                    ...
                    <div id="foot_operate_area">
                        <div id="bottomOperate" class="info_operate info_operate_fixed clearfix" >
                            ...
                            <div class="fr">
                            	<span class="btn btn_primary btn_input "><@ctl.button id="form_submit" class="js_btn"  text="submit"   /></span>
                            </div>
                        </div>
                    </div>
			    ...
			    <div class="financ_apl_pop fancybox_pop" id="financ_return_button">
			        ...
			        <p class="form_btn">
			            <@ctl.linkButton  href="${taglibs.allctx}/loan/apply/enterprise.htm" id="return_submit"  text="confirm"   />
			            <@ctl.linkButton  id="return_cancel" class="btn"  text="cancel"   />
			        </p>
			    </div>
			    <#include "${taglibs.ftlctx}/loan/apply/enterprise/javascript.ftl"/>
