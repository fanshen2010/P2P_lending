						...
						<div class="search_list clearfix">
							<div class="sl_li">
								...
								<div class="frm_controls">
									<@ctl.text name="userCriteria.subject" value="${(userCriteria.subject)!}"/>
								</div>
							</div>
							<div class="sl_li sl_btn">
								<@ctl.linkButton id="user_search" title="search" text="search"/>
							</div>
						</div>
					</div>
					<div class="main_list">
							...
							<div class="nowrap_table">
								<table class="table form_wrp_padding table-stripd table-hover" cellpadding="0" cellspacing="0">
									...
									<tbody class="tbody" id="">
										<#if userLogs?has_content>
										<#list userLogs as messageLog>
										<tr>
						...
						<@ctl.pageAjax page=userCriteria.page url="userPage.htm"  elemId="tab_show"/>
					</div>
				</form>
			</div>
		</div>
