 ...
 * 
 *
 * Title:        CustPersonalInfoCriteria.java
 * Description:       查询条件CustPersonalInfoCriteria类定义
 *
 * Dependencies:
 * 
 * History:
...
public class CustPersonalInfoCriteria extends BaseCriteria {
    ...
    public CustPersonalInfoCriteria() {
